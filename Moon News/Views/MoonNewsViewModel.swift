...
//                    print("Successfully fetched \(articles.count) articles.")
                ...
                case .failure(let error):
                    ...
                    self?.news = [
                        SpaceData(id: 0, title: "error", url: "error", imageUrl: "error", newsSite: "error", summary: error.localizedDescription, publishedAt: "error", updatedAt: "error", featured: false)
                    ]
                }
            }
        }
